...
const AddBoard = () => {
  ...
  return (
    ...
    <div onClick={e => {
          ...
          e.stopPropagation();
        }} className={`w-[300px] xs:w-[500px] sm:w-[600px] h-fit rounded-md ${dark ? 'bg-gray-7 text-white' :'bg-white text-slate-500'} p-5 flex flex-col gap-5 relative`}>
          ...
          <button className='w-80vw bg-purple-1 text-white font-medium rounded-3xl py-2 text-xs' onClick={addBoard}>Create New Board</button>
